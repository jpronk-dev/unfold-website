    ...
    <main className="w-full overflow-x-hidden">
      ...
      >
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-20 lg:gap-20 w-full max-w-[1280px]">
          ...
          <FadeIn className="self-center lg:self-auto">
            <PhoneMockup src="/images/app-screen1-en.png" alt="Unfold app — question card" />
          </FadeIn>
        </div>
      </section>
      ...
      >
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-20 lg:gap-20 w-full max-w-[1280px]">
          <FadeIn className="order-last lg:order-first self-center lg:self-auto">
            <PhoneMockup src="/images/app-screen2-en.png" alt="Unfold app — choose your vibe" />
          </FadeIn>
      ...
      >
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-20 lg:gap-20 w-full max-w-[1280px]">
          ...
          <FadeIn className="self-center lg:self-auto">
            <PhoneMockup src="/images/app-screen3-en.png" alt="Unfold app — hot takes" />
          </FadeIn>
        </div>
      </section>
